...
run_ani_R =[pygame.image.load("assets\sprites\megaman\megaman_walking1-right.png"),
...
run_ani_L = [pygame.image.load("assets\sprites\megaman\megaman_walking1-left.png"),
...
class Background(pygame.sprite.Sprite):
      def __init__(self):
            super().__init__()
            self.bgimage = pygame.image.load("assets/backgrounds/Background.png")
...
class Ground(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("assets/backgrounds/Ground.png")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYUP:
         if event.key == pygame.K_LEFT or pygame.K_RIGHT:
          player.image = pygame.image.load('assets\sprites\megaman\megaman_stand1.png')
          print("cheguei")
